...
export default function BooksList(props) {
    ...
    useEffect(() => {
        ...
        {
            fetch(`https://books-raider-backend.onrender.com/books/${props.user.recentBooks[0]}`).then(res => res.json()).then((result) => {setData(data => [...data,result]);setLoadingData1 (false); },(error) => {setError(error);})
        }
        ...
        {
            fetch(`https://books-raider-backend.onrender.com/books/${props.user.recentBooks[1]}`).then(res => res.json()).then((result) => {setData(data => [...data,result]);setLoadingData2 (false); },(error) => {setError(error);})
        }
        ...
        {
            fetch(`https://books-raider-backend.onrender.com/books/${props.user.recentBooks[2]}`).then(res => res.json()).then((result) => {setData(data => [...data,result]);setLoadingData3 (false); },(error) => {setError(error);})
        }
        ...
        {
            fetch(`https://books-raider-backend.onrender.com/books/${props.user.recentBooks[3]}`).then(res => res.json()).then((result) => {setData(data => [...data,result]);setLoadingData4 (false); },(error) => {setError(error);})
        }
        ...
        {
            fetch(`https://books-raider-backend.onrender.com/books/${props.user.recentBooks[4]}`).then(res => res.json()).then((result) => {setData(data => [...data,result]);setLoadingData5 (false); },(error) => {setError(error);})
        }
